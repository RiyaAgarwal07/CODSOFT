...
#bg = ImageTk.PhotoImage(file="Python_Task1_WeatherForecasting\grass.png")

image = PhotoImage(file="Python_Task1_WeatherForecasting\cl1.png")  # Replace with the path to your image
...
def getWeather():
    try:
        ...
        #Weather
        api = "https://api.openweathermap.org/data/2.5/weather?q=" + city + "&appid=433f11f719a5fc53d084f98442cf8117"
...
#Search box
Search_image = PhotoImage(file="Python_Task1_WeatherForecasting/search.png")
...
#Search icon 
Search_icon = PhotoImage(file="Python_Task1_WeatherForecasting/search_icon.png")
